...
class TestBookReader:
    ...
    def test_book_has_required_attributes(self):
        """Test that each book has title, author, description, and url attributes."""
        books = read_books()
        for book in books:
    ...
    def test_books_have_non_empty_descriptions(self):
        """Test that all books have non-empty descriptions."""
        books = read_books()
        for book in books:
